      ...
      <section style={{ padding:"60px 5%", background:W }}>
        <div style={{ maxWidth:800, margin:"0 auto" }}>
          ...
          <div className="legal-section">
            ...
            <ul>
              <li>SubSeat charges a platform fee of 6% plus VAT on all subscription revenue collected through the platform</li>
              <li>Payouts are processed weekly via Stripe to your connected bank account</li>
              ...
              <li>SubSeat reserves the right to adjust platform fees with 30 days written notice</li>
            </ul>
          </div>
